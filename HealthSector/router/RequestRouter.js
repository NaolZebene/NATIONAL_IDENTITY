...
// View all requests
router.get('/requests',isLoggedIn,authorize(['admin', 'lab_tech', 'doctor', "card"]), requestController.viewAll);
// View details of a specific request
router.get('/requests/:id',isLoggedIn,authorize(['admin', 'lab_tech', 'doctor', "card"]), requestController.viewDetails);
